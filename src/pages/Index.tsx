...
import { Coins, Trophy, Gamepad, ArrowRight, Sparkles, Flame, Dice, Cards, Joystick } from "lucide-react";
...
const gameCategories = {
  ...
  table: {
    title: "Table Games",
    icon: <Cards className="h-6 w-6 text-accent" />,
    games: [
      {
  ...
  dice: {
    title: "Dice Games",
    icon: <Dice className="h-6 w-6 text-secondary" />,
    games: [
      {
        title: "Craps Master",
